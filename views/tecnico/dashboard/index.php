<h1 class="dashboardtecnico__mensaje">Bienvenido Señor Tecnico: <?php echo $nombre; ?></h1>
<div class="dashboardtecnico__grid">
    <div>
        <div class="dashboardtecnico__navegacion">
            <a class="dashboardtecnico__navegacion-enlace" href="/tecnico/nuevasconexiones/index">
                <i class="dashboardtecnico__navegacion-icono fa-solid fa-water"></i>
                <h4 class="dashboardtecnico__navegacion-etiqueta">Nuevas Conexiones</h4>
            </a>
            <a class="dashboardtecnico__navegacion-enlace" href="/tecnico/solicitudes">
