                ...
                <?php foreach ($trabajos as $trabajo) { ?>
                    <tr class="table__tr">
                        ...
                        <td class="table__td--acciones">
                            <a class="table__accion table__accion--editar" href="/tecnico/nuevasconexiones/proceso?id=<?php echo $trabajo->id; ?>">
...
?>
    <script>
        Swal.fire({
            title: '¡Éxito!',
            text: 'Se Finalizo la tarea correctamente.',
            icon: 'success',
            timer: 3000,
            confirmButtonText: 'OK'
        }).then(() => {
            window.location.href = '/tecnico/nuevasconexiones/encurso'; // Redirigir después de cerrar la alerta
        });
    </script>
<?php
