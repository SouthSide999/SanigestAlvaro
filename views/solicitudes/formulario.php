<fieldset class="formulario__fieldset">
    ...
    <fieldset class="formulario_nueva_conexion__fieldset">
        ...
        <div class="formulario__campo">
            ...
            <input type="text" id="tipo_solicitud_id" class="formulario__input" value="<?php echo $solicitud->tipo->nombre; ?>" readonly>
        </div>
        ...
        <div class="formulario__campo">
            ...
            <input type="text" id="estado_id" class="formulario__input" value="<?php echo $solicitud->estado->nombre; ?>" readonly>
        </div>

        <div class="formulario__campo">
            <label for="personal_asignado" class="formulario__label">Personal Asignado</label>
            <input type="text" id="personal_asignado" class="formulario__input" value="<?php echo $solicitud->personal->nombre . ' ' . $solicitud->personal->apellido; ?>" readonly>
        </div>
        ...
        <div class="formulario__campo">
            <label for="observaciones" class="formulario__label">Observaciones <small>* Ingresa solo si vas a finalizar la solicitud.</small></label>
            <textarea id="observacionesConcluido" name="observacionesConcluido" placeholder="Escribe las observaciones..." class="formulario__input"><?php echo $solicitud->observaciones; ?></textarea>
        </div>
    </fieldset>
