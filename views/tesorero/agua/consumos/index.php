...
<div class="dashboard__contenedor-boton">
    ...
    <a class="dashboard__boton" href="/tesorero/consumos/crear">
        <i class="fa-solid fa-circle-plus"></i>
        Nuevo Consumo
    </a>
    <a class="dashboard__boton" href="/tesorero/consumos/generar">
        <i class="fa-solid fa-circle-plus"></i>
...
<div class="dashboard__contenedor-buscador">
    <form class="dashboard__formulario__buscardor" action="/tesorero/consumos" method="POST">
        ...
        <div class="dashboard__contenedor__boton">
            ...
            <a href="/tesorero/consumos" class="dashboard__boton__buscardor">
                Lista Completa
            </a>
        </div>
    </form>
                ...
                <?php foreach ($consumos as $consumo) { ?>
                    <tr class="table__tr">
                        ...
                        <td class="table__td--acciones">
                            <a class="table__accion table__accion--editar" href="/tesorero/consumos/editar?id=<?php echo $consumo->id; ?>">
                                <i class="fa-solid fa-pen-to-square"></i>
                                Editar
                            </a>
                            <form method="POST" action="/tesorero/consumos/eliminar" class="table__formulario">
