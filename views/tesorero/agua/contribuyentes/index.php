...
<div class="dashboard__contenedor-boton">
    <a class="dashboard__boton" href="/tesorero/agua">
        ...
        <a class="dashboard__boton" href="/tesorero/contribuyentes/crear">
...
<div class="dashboard__contenedor-buscador">
    <form class="dashboard__formulario__buscardor" action="/tesorero/contribuyentes" enctype="multipart/form-data" method="POST">
        ...
        <div class="dashboard__contenedor__boton">
            ...
            <a href="/tesorero/contribuyentes" class="dashboard__boton__buscardor">
                Lista Completa
            </a>
        </div>
    </form>
                ...
                <?php foreach ($contribuyentes as $contribuyente) { ?>
                    <tr class="table__tr">
                        ...
                        <td class="table__td--acciones">
                            <!-- Editar -->
                            <a class="table__accion table__accion--editar" href="/tesorero/contribuyentes/editar?id=<?php echo $contribuyente->id; ?>">
                                <i class="fa-solid fa-user-pen"></i>
                                Editar
                            </a>

                            <!-- Eliminar -->
                            <form method="POST" action="/tesorero/contribuyentes/eliminar" class="table__formulario">
