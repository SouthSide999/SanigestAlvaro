...
<div class="dashboard__contenedor-buscador">
    <form class="dashboard__formulario__buscardor" action="/tesorero/resumen" method="POST">
        ...
        <div class="dashboard__contenedor__boton">
            ...
            <a href="/tesorero/resumen" class="dashboard__boton__buscardor">Lista Completa</a>
        </div>
    </form>
</div>
                ...
                <?php foreach ($registros as $registro) { ?>
                    <tr class="table__tr">
                        ...
                        <td class="table__td--acciones">
                            <!-- Detalle -->
                            <a class="table__accion table__accion--editar" href="/tesorero/resumen/detalle?id=<?php echo $registro->id; ?>">
