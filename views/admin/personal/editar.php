<h2><?php echo $titulo ." ".$personal ->nombre ." ". $personal ->apellido?></h2>

<div class="dashboard__contenedor-boton">
    <a class="dashboard__boton" href="/admin/personal">
...
<div class="dashboard__formulario">
    ...
    <form class="formulario" enctype="multipart/form-data" method="POST">
        ...
        <input
            type="submit"
            value="Actualizar Datos Del Personal"
...
<?php if (isset($_GET['actualizado']) && $_GET['actualizado'] == 1) : ?>
    <script>
        Swal.fire({
            ...
            window.location.href = "/admin/personal"; // Redirigir al listado
        });
    </script>
<?php endif; ?>
