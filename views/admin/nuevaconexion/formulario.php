<fieldset class="formulario__fieldset">
    ...
    <fieldset class="formulario_nueva_conexion__fieldset">
        ...
        <div class="formulario__campo">
            <label for="nombre" class="formulario__label">Codigo de Seguimiento</label>
            <input type="text" class="formulario__input" value="<?php echo $nueva->codigo_seguimiento; ?>" readonly>
        </div>
