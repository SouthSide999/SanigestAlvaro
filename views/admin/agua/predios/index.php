...
<div class="dashboard__contenedor-boton">
    ...
    <a class="dashboard__boton" href="/admin/predios/crear">
...
<div class="dashboard__contenedor-buscador">
    <form class="dashboard__formulario__buscardor" action="/admin/predios" enctype="multipart/form-data" method="POST">
        <fieldset class="formulario__fieldset">
            <div class="formulario__campo">
                <label for="buscar_por" class="formulario__label">Buscar por:</label>
                <select class="formulario__input" id="criterio" name="criterio" required>
        ...
        <div class="dashboard__contenedor__boton">
            ...
            <a href="/admin/predios" class="dashboard__boton__buscardor">
                Lista Completa
            </a>
        </div>
    </form>
                ...
                <?php foreach ($predios as $predio) { ?>
                    <tr class="table__tr">
                        ...
                        <td class="table__td--acciones">
                            <!-- Editar -->
                            <a class="table__accion table__accion--editar" href="/admin/predios/editar?id=<?php echo $predio->id; ?>">
                                <i class="fa-solid fa-pen-to-square"></i>
                                Editar
                            </a>

                            <!-- Eliminar -->
                            <form method="POST" action="/admin/predios/eliminar" class="table__formulario">
