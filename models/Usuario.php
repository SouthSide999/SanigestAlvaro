...
class Usuario extends ActiveRecord {
    ...
    protected static $columnasDB = ['id', 'nombre', 'apellido', 'email', 'password', 'confirmado', 'token', 'rol_id'];
    ...
    public function validar_personal()  {
        if(!$this->nombre) {
        ...
        if(!$this->rol_id) {
            self::$alertas['error'][] = 'Debe seleccionar un Rol';
        }
        return self::$alertas;
    }
